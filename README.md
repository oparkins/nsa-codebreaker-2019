# NSA Codebreaker 2019 Writeups
## Owen Parkins

This repo does not have all tasks included in the writeup. Unfortunately, after I completed Codebreaker, I had to start working on my thesis. Someday I may find the energy to go back and fill in the last few tasks, but currently I need to focus on graduating.

Most of the information below was taken from the main website at: https://codebreaker.ltsnet.net/challenge
